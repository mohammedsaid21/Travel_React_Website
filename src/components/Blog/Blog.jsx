    ...
    <section className="blog container section" id="blog">
      <div className="secContainer">
        <div className="secIntro">
          <h2 data-aos="fade-up" data-aos-duration = "1600" className="secTitle">Our Best Blog?</h2>
          <p data-aos="fade-up" data-aos-duration = "1000">An insight to the incredible experince in the world.</p>
        </div>

        <div className="mainContainer grid">
          {posts.map(({id, postImage, title, desc}) => {
            return (
              <div data-aos="fade-up" data-aos-duration = "1000" className="singlePost grid">
                <div className="imgDiv">
                  <img src={postImage} alt={title} />
                </div>

                <div className="postDetails">
                  <h3 data-aos="fade-left" data-aos-duration = "1000">{title}</h3>
